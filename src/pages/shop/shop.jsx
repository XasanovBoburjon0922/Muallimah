...
const Books = () => {
  ...
  const fetchBooks = async (page = 1, categoryIds = [], search = "") => {
    try {
      let url = `https://beta.themuallimah.uz/v1/product/list?type=product&page=${page}&limit=10&language=${i18n.language}`;
    ...
    <Layout>
      ...
      <Content style={{ padding: "24px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "24px" }}>
          <h1 style={{ fontSize: "24px", fontWeight: "bold" }}>{t("products")}</h1>
        </div>
